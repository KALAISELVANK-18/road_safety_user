  ...
  fetchLocations(double latitude, double longitude) async {
    try {
      ...
      http.Response response = await http.get(Uri.parse(
          'https://maps.googleapis.com/maps/api/place/nearbysearch/json?keyword=dentist&location=$latitude,$longitude&radius=10000&type=hospital&key=AIzaSyDLo8dy5jkBPcvZyEgUyA88SGVyHllZgio'));
