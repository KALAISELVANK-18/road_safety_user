...
class _SpeedState extends State<Speed> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:StreamBuilder<QuerySnapshot>(
        stream:FirebaseFirestore.instance.collection("notifications").where("type",isEqualTo: "speedlimit").snapshots(),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: (nn[ind]["status"]==0)?TextButton(onPressed: (){

                                                },child: Row(
                                                  children: [
                                                    Text("put fine",style: TextStyle(color: Colors.black)),

                                                  ],
                                                ),):Text("responded",style: TextStyle(color: Colors.green))),
